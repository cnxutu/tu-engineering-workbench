...
1. Read the P0 root `AGENTS.md`, identify the explicit project scope, and resolve paths through `workspace.local.yaml`. P0 supplies guidance and product knowledge; it is not automatically a code-change participant.
