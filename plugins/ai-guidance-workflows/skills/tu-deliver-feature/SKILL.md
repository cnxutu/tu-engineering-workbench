...
2. For an existing ID, locate the package, read `task.yaml`, `resume.md`, and the current phase Artifact before inspecting code or acting. If an Artifact is absent, report its absence rather than inventing prior decisions.
