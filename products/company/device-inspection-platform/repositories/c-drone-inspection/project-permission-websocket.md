...
```json
{
  ...
  "timestamp": 0,
  "data": [
    {"userId": 1001, "projectCodeList": ["PROJECT-001"], "projectSetCode": "PROJECT-SET-001", "projectSetName": "华东区域项目集"}
  ]
}
```
...
| `projectSetCode` | 被删除的项目集编码；仅 `PROJECT_SET_REMOVED` 项目集删除事件返回，其他事件省略。 |
